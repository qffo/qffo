...
- Мои проекты
  - [Игры разума - набор из пяти консольных игр. ](https://github.com/qffo/python-project-49)
  - [Вычислитель отличий - программа определяет разницу между двумя структурами данных](https://github.com/qffo/python-project-50)
  - [Анализатор страниц - веб-приложение проверяет сайт на SEO пригодность](https://github.com/qffo/python-project-83)
